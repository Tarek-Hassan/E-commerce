<div>
	...
	<main id="main">
		<div class="container">
			...
			@if (count($sproducts) > 0 && $sale_date > now())				
				<div class="wrap-show-advance-info-box style-1 has-countdown">
					<h3 class="title-box">On Sale</h3>
					<div class="wrap-countdown mercado-countdown" data-expire="{{$sale_date}}"></div>
							...
							<div class="product product-style-2 equal-elem ">
								<div class="product-thumnail">
									<a href="{{route('product.detail',['slug'=>$sproduct->slug])}}" title="{{$sproduct->name}}">
										<figure><img src="{{asset($sproduct->image)}}" width="800" height="800" alt=""></figure>
									</a>
